...
export class ValidatorByNumberRequest extends jspb.Message { 
    ...
    static deserializeBinaryFromReader(message: ValidatorByNumberRequest, reader: jspb.BinaryReader): ValidatorByNumberRequest;
}
...
export class BlockchainInfoResponse extends jspb.Message { 
    ...
    static deserializeBinaryFromReader(message: BlockchainInfoResponse, reader: jspb.BinaryReader): BlockchainInfoResponse;
}
...
export class SendRawTransactionRequest extends jspb.Message { 
    ...
    static deserializeBinaryFromReader(message: SendRawTransactionRequest, reader: jspb.BinaryReader): SendRawTransactionRequest;
}
...
export class SendRawTransactionResponse extends jspb.Message { 
    ...
    static deserializeBinaryFromReader(message: SendRawTransactionResponse, reader: jspb.BinaryReader): SendRawTransactionResponse;
}
