...
describe('[Address]', () => {
  it('Should Be Able to Create Address from PublicKey', async (done) => {
    ...
    addr = new Address('zc1h87hfkn3wa36xwypjz8aep3hu4ssdrt804nykz', Buffer.from(pub, 'hex'));
  ...
  it('should fail on invalid Address', async (done) => {
    expect(() => Address.DecodeFromBech32('zs1sgwuqf5wlng5rgpjtqm0v9u78n9x0mn50udll3')).toThrowError(
  ...
  it('Should generate Address from Public Key', async (done) => {
    ...
    expect(Address.FromPublicKey(Buffer.from(pub, 'hex')).toString('hex')).toEqual(
      '00b9fd74da717763a33881908fdc8637e561068d67',
    );
  ...
  it('Should Verify Address by Pubkey', async (done) => {
    const address = new Address('zc1h87hfkn3wa36xwypjz8aep3hu4ssdrt804nykz');
    expect(
      address.Verify(
        Buffer.from(
          '6df01b4b4f49b26692d83add4bf9a47c8a3b5db2f5000b80a399a9b1b6afe04f8afd6749354e3f766c877b2837351004a279f4834dd532018766c0446cec1d1903735d52cafdb5ad2c61764fe89da05d139f7efe5f049d8ec92727ba93c74595',
  ...
  it('Should Encode to Bech32', async (done) => {
    ...
    expect(encoded).toEqual('zc1h87hfkn3wa36xwypjz8aep3hu4ssdrt804nykz');

    done();
  });

  it('Should Decode from Bech32', async (done) => {
    const decoded = Address.DecodeFromBech32('zc1h87hfkn3wa36xwypjz8aep3hu4ssdrt804nykz');

    expect(decoded.toString('hex')).toEqual('00b9fd74da717763a33881908fdc8637e561068d67');
