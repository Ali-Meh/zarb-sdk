...
describe('[Address]', () => {
  ...
  it('should fail on invalid Address', async (done) => {
    expect(() => Address.DecodeFromBech32('srb17mka0cw484es5whq638xkm89msgzczmrpd86dv')).toThrowError(
      new Error("Prefix Doesn't match"),
    );
    expect(() => Address.DecodeFromBech32('zrb17mka0cw484es5whq638xkm89msgzczmrwy64dz')).toThrowError(
